...
export default function NFTDetails() {
  ...
  const [listing, setListing] = useState<ListringInterface>();
  ...
  async function fetchNFTDetails() {
    const ERC721Contract = new Contract(nftAddress as string, erc721ABI, signer as Signer);
        ...
        {loading ? (
          ...
          <div className={styles.container}>
            <div className={styles.details}>
              ...
              <span>Price: {formatEther(listing?.price as BigNumberish)} CELO</span>
              <span>
                <a
